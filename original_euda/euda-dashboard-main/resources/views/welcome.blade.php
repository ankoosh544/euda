...
<?php
/**
$file = '1687180020000_1687180050000_880819439345_mcallinn_iotanalytics_0_336.0.s3_pipeline.json.gz';
$contents = Storage::disk('s3')->get('datastore/mcallinn_data/__dt=2023-06-19 00:00:00/' . $file);
$json = json_decode(gzdecode($contents));
*/
?>
